...
The order of expression definitions found in the antlr grammar indicates
the token precedence. These are the operators listed from strongest to weakest binding:
