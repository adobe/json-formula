...
The antlr grammar defines operator precedence by virtue of the order of expressions in the grammar. These are the operators listed from strongest to weakest binding:
