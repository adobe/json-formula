...
When brackets enclose an expression (`'[' expression ']'`), the results of that expression are used to index into an array.
The bracketed expression is expected to return an integer value to return an offset in the array.
